...
image_path = "../images/demo/demo.jpg"
detection_model_path = '../trained_models/detection_models/haarcascade_frontalface_default.xml'
# emotion_model_path = '../trained_models/emotion_models/fer2013_mini_XCEPTION.102-0.66.hdf5'
emotion_model_path = '../trained_models/emotion_models/fer2013_compact_cnn.01-0.42.hdf5'
...
input_s = image_path.split("/")
out_name = input_s[len(input_s) - 1]
cv2.imwrite('../images/predict_demo' + "/" + out_name, bgr_image)
